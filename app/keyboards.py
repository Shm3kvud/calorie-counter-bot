...
#gain/lose weight
gain_lose_weight = ReplyKeyboardMarkup(keyboard=[
    [KeyboardButton(text="Набрать")],
    [KeyboardButton(text="Похудеть")]
], resize_keyboard=True)

#set kbju by AI
activity = ReplyKeyboardMarkup(keyboard=[
...
auto_or_by_yrslf = ReplyKeyboardMarkup(keyboard=[
    [KeyboardButton(text="Самостоятельно")],
    [KeyboardButton(text="Автоматически")]
], resize_keyboard=True)

#continue or again
continue_or_again = ReplyKeyboardMarkup(keyboard=[
