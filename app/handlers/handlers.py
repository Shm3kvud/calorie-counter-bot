...
@router.message(F.text == "🥗 Добавить продукты")
async def add_product(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        'просьба формировать описание подробно, т. к. '
        'при описании "чай с 3 кубиками сахара и бутерброды" '
        'он его не распознает. Хороший пример: "1 кружка '
        'черного чая с 3 средними кубиками сахара и 3 бутерброда с колбасой и сыром"'
    )
